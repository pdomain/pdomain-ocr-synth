...
echo "   Watch the release workflow: https://github.com/pdomain/pdomain-ocr-synth/actions"
echo "   Release page (once workflow finishes): https://github.com/pdomain/pdomain-ocr-synth/releases/tag/$VERSION"
